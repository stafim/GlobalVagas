...
- **Favicon**: Custom favicon with Operlist logo design applied to the website. The icon features a clean, minimalist 'O' lettermark in teal color (hsl 170, 65%, 38%) optimized for display across different devices and sizes (16x16, 32x32, 180x180 for Apple devices).
